...
const health = { status: 'DEGRADED', observedAt: NOW, postgresql: { status: 'AVAILABLE' }, http: { status: 'AVAILABLE' }, pipeline: { pumpfun: 'RUNNING', pumpswap: 'RUNNING', paperDecision: 'RUNNING', qualification: 'RUNNING', social: 'RUNNING' }, qualification: { currentCount: 2, lastSuccessAt: NOW }, socialJobs: { pendingCount: 0, leasedCount: 0, retryableFailedCount: 0, exhaustedCount: 0 }, paperDecisionJobs: { pendingCount: 0, leasedCount: 0, retryableFailedCount: 0, exhaustedCount: 0, lastSuccessAt: NOW, lastErrorCode: null }, checkpoints: { launchpad: '100', market: '100' }, heartbeat: { startedAt: NOW, updatedAt: NOW, lastHttpSlot: '100', lastWebsocketSlot: '100', lastFinalizedSlot: '100', lastSignature: null, pendingTransactions: 0, activeSessions: 0, websocket: { version: 1, supervision: 'ACTIVE', state: 'DEGRADED', phase: 'RECOVERING', providerId: 'primary', candidateProviderId: 'fallback-1', updatedAt: NOW, heartbeatAt: NOW, acknowledgedAt: NOW, lastObservation: { observedAt: NOW, slot: '900719925474099312345' }, disconnect: { occurredAt: NOW, reasonCode: 'REMOTE_CLOSE' }, recovery: { status: 'IN_PROGRESS', startedAt: NOW, completedAt: null, reasonCode: 'SESSION_FAILURE' }, rpcUrl: 'https://e2e-secret.invalid/key', signature: 'e2e-secret-signature', remoteReason: 'e2e raw close detail' } }, lagSlots: '0' };
