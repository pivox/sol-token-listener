...
export const health = {
  ...
  heartbeat: {
    ...
    websocket: {
      ...
      heartbeatAt: NOW,
      acknowledgedAt: NOW,
      lastObservation: { observedAt: NOW, slot: '900719925474099312345' },
      disconnect: { occurredAt: NOW, reasonCode: 'REMOTE_CLOSE' },
      recovery: {
        status: 'IN_PROGRESS', startedAt: NOW, completedAt: null, reasonCode: 'SESSION_FAILURE',
      },
    },
  },
  lagSlots: '1',
