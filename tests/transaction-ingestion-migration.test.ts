...
void test('applies migrations 001-017 on an empty PostgreSQL schema and replays cleanly', async (context) => {
  ...
  try {
    ...
    assert.equal(applied.at(-1), '017_creation_entry_strategy.sql');
