...
function projectTokenLaunch(
  ...
  return Object.freeze({
    ...
    parameters: Object.freeze({
      ...
      requestedCreator: creation.requestedCreator,
      effectiveCreator: creation.effectiveCreator,
      creatorFeeBps: creation.creatorFeeBps,
      holderReward: creation.isHolderReward,
