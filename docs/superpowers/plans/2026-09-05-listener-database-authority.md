...
- [x] **Step 3: Implement the minimal SQL authority**
...
- [x] **Step 1: Write the failing PostgreSQL integration assertions**
...
- [x] **Step 2: Run the integration test against PostgreSQL 16**
...
- [x] **Step 5: Verify the real bounded paper probe**
...
- [x] **Step 1: Update versioned architecture documentation**
